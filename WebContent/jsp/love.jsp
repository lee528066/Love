...
<head>
	...
	<style type="text/css">
		@font-face {
			font-family: digit;
			src: url('${pageContext.request.contextPath}/jsp/digital-7_mono.ttf') format("truetype");
		}
	</style>
	<link href="${pageContext.request.contextPath}/css/default.css" type="text/css" rel="stylesheet">
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/garden.js"></script>
...
<body>
	<div id="mainDiv">
		<div id="content">
			<div id="code">
				...
				<span class="space"/><span class="comments">* We are both IT Jobers,</span><br />
				<span class="space"/><span class="comments">* Today I write some code to celebrate your birthday.</span><br />
				<span class="space"/><span class="comments">*/</span><br />
				Boy i = <span class="keyword">new</span> Boy(<span class="string">"liwei"</span>);<br />
				Girl u = <span class="keyword">new</span> Girl(<span class="string">"liuwenjing"</span>);<br />
				<span class="comments">// May 23, 2016, I told you I love you. </span><br />
				i.love(u);<br />
			...
			<div id="loveHeart">
				...
				<div id="words">
					<div id="messages">
						Liuwenjing, I have fallen in love with you for
						<div id="elapseClock"></div>
					</div>
					<div id="loveu">
						Love u forever and ever.<br/>
						<div class="signature">- liwei</div>
					</div>
				</div>
			</div>
		</div>
		<div id="copyright">
			...
			Copyright © 2016 <a href='http://www.leelovelwj.com'>www.leelovelwj.com</a> 2016-2016
		</div>
	</div>
	<script type="text/javascript">
		...
		together.setFullYear(2016, 05, 23);
